...
<br>
			...
			<c:forEach var="file" items="${fileList }" varStatus="status">
				<div class="row  justify-content-center">
					...
					<c:if test="${status.index lt 1 }">
						<img src="/resources/upload/owner/company/notice/${file.storedFileName }" style="width: 400px; height: 400px;">
					</c:if>
					</div>
				</div>
			</c:forEach>
	...
	<div class="row justify-content-center">
		<div class="col-6">
			<button type="button" id="" class="btn btn-outline-secondary text-dark fw-bold form-control">소식 더보기</button>
		</div>
	</div>
</main>

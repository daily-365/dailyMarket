  	...
  	<div class="row text-center" id="hitEstateWrap">
  		...
  		<c:if test="${not empty hitList.regDate3 }">
	  		<div class="col-3">
		  		...
		  		<br><br>
		  		<a href="/user/estate/detail?esNo=${hitList.esNo }" class="fw-bold text-dark">${hitList.esRoomType } ( ${hitList.esTradeType } ) ${hitList.esPrice } </a>
		  		<br><br>
	...
	<div class="row text-center " id="locEstateWrap">
  		...
  		<c:if test="${not empty locList.regDate3 }">
	  		<div class="col-3">
		  		...
		  		<br><br>
		  		<a href="/user/estate/detail?esNo=${locList.esNo }" class="fw-bold text-dark">${locList.esRoomType } ( ${locList.esTradeType } ) ${locList.esPrice } </a>
		  		<br><br>
...
$(document).ready(function(){
	...
	function locEstateMoreFunc(){
		var addr = localStorage.getItem("roadNameAddr").substring(6,8) 

...
<section class="container">
	<form id="excelForm" class="form" method="post">
		<div class="row">
			...
			<div class="col-1">
				<button type="button" id="oneMonthBtn" class="btn btn-warning form-control">1개월</button>
			</div>
			<div class="col-1">
				<button type="button"  id="threeMonthBtn" class="btn btn-warning form-control">3개월</button>
			</div>
			<div class="col-1">
				<button type="button"  id="sixMonthBtn" class="btn btn-warning form-control">6개월</button>
			</div>
		</div>
		<br><br>
		<div class="row">
			...
			<div class="col-2">
				<button id="searchBtn"  type="button" class="form-control btn btn-outline-warning">검색</button>
			</div>
			<div class="col-2">
...
<br><br>
	<div class="text-center">
		<a class="btn btn-warning" href="${pageMaker.makeSearch(1) }">&laquo;&laquo;</a>
		<c:if test="${pageMaker.prev }">
			<a class="btn btn-outline-warning" href="${pageMaker.makeSearch(pageMaker.startPage-1) }">&laquo;</a>
		</c:if>
		<c:forEach var="idx" begin="${pageMaker.startPage }" end="${pageMaker.endPage +1}"  >
			<a class="btn btn-outline-warning <c:if test="${param.page eq idx}">active</c:if>"  href="${pageMaker.makeSearch(idx) }">${idx}</a>
		</c:forEach>

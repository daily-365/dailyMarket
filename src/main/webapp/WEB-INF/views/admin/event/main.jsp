...
<section class="container">
	<form id="excelForm" class="form" method="post">
		...
		<div class="row">
			...
			<div class="col-2">
				<button onclick="javascript: self.location='/admin/event/main'" type="button" class="form-control btn btn-outline-dark">검색 초기화</button>
			</div>
		</div>
	</form>
</section>
...
<main class="container-fluid">
	<br>
	<h4 class="text-center">이벤트 등록 현황</h4>
	<br>
	<table class="table table-hover table-bordered fw-bold container">
		...
		<tr>
			<td>${list.rnum }</td>
			<td>${list.eventNo }</td>
			<td><a  class="text-dark"  href="/admin/event/detail?eventNo=${list.eventNo}">${fn:substring(list.title,0,30)}...</a></td>
...
$(document).ready(function(){
    ...
    $("#searchBtn").on("click",function(){
    	self.location="/admin/event/main?keyword="+$("#keyword").val()+"&searchType="+$("#searchType").val()+"&startDate="+$("#startDate").val()+"&endDate="+$("#endDate").val()+"&pagePerNum="+$("#pagePerNum").val()
    });
    ...
    $("#excelDown").on("click",function(){
    	$("#excelForm").attr("action","/admin/event/excelDown")
		$("#excelForm").submit();
